	...
	if(isset($_POST['searchPlate']))
	{
		...
		while($r=mysqli_fetch_array($q))
		{
			...
			<tr>
				...
				<td align='center'><a href='manager.php?vview={$r['Vehicle_ID']}' style='color: black;'><i class='fa fa-edit' style='font-size:20px'></i></a> | <a href='manager.php?deleteVehicle={$r['Vehicle_ID']}' ";
				?>
	...
	<div class="modal-car">
		...
		<form action='#' method='POST'>
			<table cellspacing='10' width='30%' border='0' bgcolor='white' style='margin: 60px; border-radius: 20px;'>
				...
				<tr>
					<td bgcolor='white'><font style='font-size: 12px;'><b>Start Date:</b></font><br><input type='date' name='PMSStart' required></td>
					<td bgcolor='white'><font style='font-size: 12px;'><b>End Date:</b></font><br><input type='date' name='PMSEnd' required></td>
				</tr>
				<tr>
